 ...
 * @param output: The the output generated by this Component
 ...
 *                It is passed here because we do not want null pointers flying around
 * @param tfSetting: The TF that manipulates the inputs and generates the output
...
abstract class ComputingElementBase 
  ...
  /**
   * The the output generated by this Component after applying the script to the inputs
   * It can or cannot be an AlarmValue
   */
  var output: HeteroInOut
  
  /**
   * The IDs of the inputs that this component needs to generate the output.
   * The list does not change during the life time of the component.
   */
  val requiredInputs: List[String]
  
  /**
   * The list of monitor points in input that generated the actual output
   */
  val inputs: MutableMap[String,HeteroInOut]
  
  /**
   * The definition of the implementation of the transfer function
   * that manipulates the inputs to produce the new output
   */
  val tfSetting: TransferFunctionSetting
  
  /**
   * The properties to pass to this component and the TF
   */
  val props: Some[Properties]
   ...
   */
  protected[compele] final val newInputs: MutableMap[String, HeteroInOut] =  new HashMap[String,HeteroInOut]()
