...
abstract class ComputingElementBase (
    ...
    final var output: HeteroInOut,
    final val requiredInputs: List[String],
    final val inputs: MutableMap[String,HeteroInOut],
    final val tfSetting: TransferFunctionSetting,
    final val props: Some[Properties] = Some(new Properties()))
    extends Runnable {
  ...
  def initialize(stpe: ScheduledThreadPoolExecutor): Unit = {
    ...
    tfSetting.initialize(id.id.get, id.runningID, new Properties())
